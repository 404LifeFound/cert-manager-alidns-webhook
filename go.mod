module github.com/404LifeFound/cert-manager-alidns-webhook

go 1.25.4

replace google.golang.org/genproto => google.golang.org/genproto v0.0.0-20230807174057-1744710a1577
